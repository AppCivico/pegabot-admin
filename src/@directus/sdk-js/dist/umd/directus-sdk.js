        ...
        API.prototype.request = function (method, endpoint, params, data, noProject, headers, skipParseToJSON) {
            ...
            return this.xhr
                ...
                if (error && error.response && errorResponseData.error) {
                    ...
                    throw new APIError("API returned invalid JSON", __assign$1(__assign$1({}, baseErrorInfo), { code: 422 }));
                }
                else {
                    throw new APIError("Network error", __assign$1(__assign$1({}, baseErrorInfo), { code: -1 }));
                }
            });
        };
        return API;
